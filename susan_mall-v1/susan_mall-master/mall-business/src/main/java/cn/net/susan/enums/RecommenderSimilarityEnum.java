...
@AllArgsConstructor
@Getter
public enum RecommenderSimilarityEnum {
     ...
     */
    SIMILARITY_PEARSON("pearson", "皮尔森相似度算法"),
     ...
     */
    SIMILARITY_EUCLIDEAN("euclidean", "欧氏距离相似度算法"),
     ...
     */
    SIMILARITY_COSINE("cosine", "余弦相似度算法"),
     ...
     */
    SIMILARITY_SPEARMAN("spearman", "Spearman秩相关系数相似度算法"),
     ...
     * 说明：比欧式距离计算量少，性能相对高。
     */
    SIMILARITY_CITY_BLOCK("cityBlock", "基于Manhattan距离相似度"),
     ...
     */
    SIMILARITY_LOGLIKELIHOOD("loglikelihood", "基于对数似然比的相似度"),
     ...
     * 说明：处理无打分的偏好数据。
     */
    SIMILARITY_TANIMOTO("tanimoto", "基于谷本系数计算相似度");
