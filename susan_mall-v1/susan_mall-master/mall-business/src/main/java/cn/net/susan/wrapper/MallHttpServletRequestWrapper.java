...
public class MallHttpServletRequestWrapper extends HttpServletRequestWrapper {

    private String body;

    public MallHttpServletRequestWrapper(HttpServletRequest request) throws IOException {
        super(request);
