    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
          ...
          <el-table-column :show-overflow-tooltip="true" prop="deptId" label="部门">
            <template slot-scope="scope">
...
let userRoles = []
let userJobs = []
const defaultForm = { id: null, userName: null, nickName: null, sex: '男', email: null, deptId: null, validStatus: '1', roles: [], jobs: [], dept: { id: null }, phone: null }
export default {
  name: 'User',
  ...
  methods: {
    ...
    getDepts() {
      getDeptTree({ queryTree: true }).then(res => {
