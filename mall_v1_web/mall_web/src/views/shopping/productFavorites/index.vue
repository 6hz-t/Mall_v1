<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        v-if="checkPer(['admin','productFavorites:edit','productFavorites:del'])"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudProductFavorites from '@/api/shopping/productFavorites'
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '商品收藏',
      url: '/v1/productFavorites/searchByPage',
      crudMethod: { ...crudProductFavorites },
      sortField: sortField
    })
  },
  ...
  data() {
    return {
      ...
      permission: {
        add: ['admin', 'productFavorites:add'],
        edit: ['admin', 'productFavorites:edit'],
        del: ['admin', 'productFavorites:del']
      }
    }
  },
  created() {
