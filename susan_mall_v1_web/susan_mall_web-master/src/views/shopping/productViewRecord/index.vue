<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        v-if="checkPer(['admin','productViewRecord:edit','productViewRecord:del'])"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudProductViewRecord from '@/api/shopping/productViewRecord'
...
export default {
  ...
  cruds() {
    return CRUD({
      ...
      crudMethod: { ...crudProductViewRecord },
      sortField: sortField
    })
  },
  ...
  data() {
    return {
      ...
      permission: {
        add: ['admin', 'productViewRecord:add'],
        edit: ['admin', 'productViewRecord:edit'],
        del: ['admin', 'productViewRecord:del']
      }
    }
  },
  created() {
