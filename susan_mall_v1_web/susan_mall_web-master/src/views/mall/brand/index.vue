  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="query.name" clearable size="small" placeholder="输入品牌名称搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
    ...
    >
      ...
      <el-table-column v-if="checkPer(['admin','brand:edit','brand:del'])" label="操作" width="130px" align="center" fixed="right">
...
export default {
  ...
  cruds() {
    return CRUD({ title: '品牌', url: '/v1/brand/searchByPage', crudMethod: { ...crudBrand }})
  },
